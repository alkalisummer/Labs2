...
(default 접근자 : 같은 폴더 안에 공유가능, 다른 폴더에 있으면 사용 불가

3. default class 는 언제 사용: 같은 폴더내에서 다른 클래스의 참조 목적으로 , 연습목적 


4. 하나의 자바 파일은(a.java) 여러개의 클래스를 가질 수 있다. 
  >> Ex01_main.java
  >> class Test{} 코딩 연습  실제로는 쓰시면 안됩니다. 
  >> 단 하나의 자바파일에서 public 키워드는 메인 클래스 하나만 갖는다.



default: 같은 폴더내에서만 사용
